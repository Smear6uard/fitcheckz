...
export function CTASection() {
  return (
    <section className="py-16 lg:py-20 bg-gradient-to-br from-primary via-primary to-[#A3424D] relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-[#A3424D]/50 rounded-full blur-3xl" />
      </div>
      ...
      <div className="mx-auto max-w-6xl px-6 relative z-10">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="font-serif text-4xl font-normal tracking-tight text-white sm:text-5xl lg:text-6xl leading-tight text-balance">
            Ready to get <span className="italic">styled</span>?
          </h2>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button
              size="lg"
              className="group/btn bg-white text-primary hover:bg-white/95 hover:scale-105 hover:brightness-110 transition-all duration-300 shadow-[0_10px_40px_rgba(255,255,255,0.3)] hover:shadow-[0_0_40px_rgba(255,255,255,0.6)] text-base px-8 py-6 w-full sm:w-auto"
              asChild
            >
            ...
            <Button
              variant="outline"
              size="lg"
              className="group/btn2 border-white/40 text-white hover:border-white hover:bg-white/20 hover:text-white hover:scale-105 hover:shadow-[0_0_25px_rgba(255,255,255,0.4)] transition-all duration-300 text-base px-8 py-6 w-full sm:w-auto bg-transparent"
              asChild
            >
