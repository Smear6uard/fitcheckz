    ...
    <section id="pricing" className="py-16 lg:py-20 bg-gradient-to-b from-zinc-950 via-zinc-950 to-zinc-900 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-6 relative">
        <div className="mx-auto max-w-2xl text-center mb-16">
          <h2 className="text-xs font-semibold text-[#14b8a6] uppercase tracking-[0.15em] mb-3">PRICING</h2>
                ...
                <div className="relative z-10">
                  ...
                  <ul className="mt-8 space-y-3 flex-1">
                    {tier.features.map((feature) => (
                      <li key={feature} className="flex items-start gap-3">
                        <Check className="h-5 w-5 flex-shrink-0 text-[#14b8a6]" />
                  ...
                  <Button
                    ...
                    className={`mt-8 w-full transition-all duration-300 ${
                      tier.featured ? "bg-[#14b8a6] text-zinc-950 hover:bg-[#0d9488] shadow-lg hover:shadow-[0_10px_40px_rgba(20,184,166,0.3)] hover:scale-[1.03]" : "hover:scale-[1.02]"
                    }`}
