...
export function WeatherBadge({
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <animated.button
              ...
              className={cn(
                "flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-500/10 to-primary/10 px-3 py-1.5",
          ...
          <TooltipContent side="bottom" className="max-w-xs">
            <div className="space-y-2">
              ...
              <p className="text-xs text-primary font-medium pt-1 border-t border-border">
  ...
  return (
    <animated.div
      style={fadeSpring}
      className={cn(
        "rounded-xl border bg-gradient-to-br from-blue-500/5 to-primary/5 p-4",
        className
      )}
    >
      {loading ? (
        ...
        <div className="flex items-center gap-4">
          <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-blue-500/20 to-primary/20">
